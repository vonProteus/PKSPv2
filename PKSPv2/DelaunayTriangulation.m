...
+ (DelaunayTriangulation *)triangulationWithRect:(CGRect)rect
{
    ...
    dt.colors = [NSArray arrayWithObjects:[NSColor redColor], [NSColor greenColor], [NSColor blueColor], nil];
    
    NSColor *color = [dt.colors objectAtIndex:arc4random() % [dt.colors count]];
